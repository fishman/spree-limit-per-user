...
desc 'Generate documentation for the limit_per_user extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'LimitPerUserExtension'
...
desc 'Test the limit_per_user extension.'
...
namespace :test do
  desc 'Functional test the limit_per_user extension.'
  ...
  desc 'Unit test the limit_per_user extension.'
